...
const API = `${process.env.REACT_APP_API_BASE_URL}OfficeAccountDetails/GetOfficeAccountDetails`;
                ...
                .map((row, index) => {
                  ...
                  return (
                    <TableRow
                      ...
                      <TableCell align="center">{row.ddoCode}</TableCell>

                      <TableCell align="center">{row.ddoCodeName}</TableCell>
