...
const API = `${process.env.REACT_APP_API_BASE_URL}Office/GetOffice`;
...
export default function EnhancedTable() {
  ...
  const handleModal = async (officeId) => {
    ...
    let result = await axios.get(
      `${process.env.REACT_APP_API_BASE_URL}Office/GetOffice/${officeId}`
    );
    const option = {
      replace: true,
      state: {
    ...
    navigate(routeNames.CREATEOFFICE, option);
  };
  ...
  const deleteOffice = (officeId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post(
            `${process.env.REACT_APP_API_BASE_URL}Office/deleteOffice/${officeId}`
          )
          .then((res) => {
            Swal.fire({
              icon: "success",
    ...
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <button
          ...
          onClick={() =>
            navigate(routeNames.CREATEOFFICE, {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.officeName}</TableCell>
                      <TableCell align="left">{row.officeNameHindi}</TableCell>
                      <TableCell align="left">{row.officeCode}</TableCell>
                      <TableCell align="left">{row.address}</TableCell>
                      <TableCell align="left">{row.stateId}</TableCell>
                      <TableCell align="left">{row.disttId}</TableCell>
                      <TableCell align="left">{row.pinCode}</TableCell>
                      <TableCell align="left">{row.stdCode}</TableCell>
                      ...
                      <TableCell align="left">{row.parentId1}</TableCell>
                      <TableCell align="left">{row.parentId1WEF}</TableCell>
                      <TableCell align="left">{row.parentId2}</TableCell>
                      <TableCell align="left">{row.parentId2WEF}</TableCell>
                      <TableCell align="left">{row.parentId3}</TableCell>
                      <TableCell align="left">{row.parentId3WEF}</TableCell>
                      <TableCell align="left">{row.parentId4}</TableCell>
                      <TableCell align="left">{row.parentId4WEF}</TableCell>
                      <TableCell align="left">{row.designationId}</TableCell>
                      <TableCell align="left">{row.officeLevelId}</TableCell>
                      <TableCell align="left">{row.rtiDesigId}</TableCell>
                      <TableCell align="left">{row.rtiJuris}</TableCell>
                      <TableCell align="left">{row.jurisdiction}</TableCell>
                      ...
                      <TableCell align="left">{row.updateOfficeId}</TableCell>
                      ...
                      <TableCell>
                        <div style={{ display: "flex" }}>
                          ...
                          btn-danger btn-sm"
                            style={{ margin: 3 }}
                            onClick={() => deleteOffice(row.officeId)}
                          >
                            <DeleteTwoToneIcon />
                          </button>
                        </div>
