...
const API = `${process.env.REACT_APP_API_BASE_URL}UserProfile/GetUserProfile`;
...
const headCells = [
  ...
  {
    id: "invalidLoginCount",
    numeric: true,
    disablePadding: false,
    label: "Invalid Login Count",
  },
  {
  ...
  const deleteUser = (userId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post(
            `${process.env.REACT_APP_API_BASE_URL}UserProfile/deleteUserProfile/${userId}`
          )
          .then((res) => {
            Swal.fire({
              icon: "success",
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.resiAdd}</TableCell>
                      <TableCell align="center">{row.stateName}</TableCell>
                      <TableCell align="center">{row.distName}</TableCell>
                      <TableCell align="center">{row.pinCode}</TableCell>
                      <TableCell align="center">{row.loginId}</TableCell>

                      <TableCell align="center">
                        {row.invalidLoginCount}
                      </TableCell>
                      <TableCell align="center">
