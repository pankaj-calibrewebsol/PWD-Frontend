...
const API = `${process.env.REACT_APP_API_BASE_URL}Module/GetModule`;
...
export default function EnhancedTable() {
  ...
  const handleModal = async (moduleId) => {
    setOpen((prevState) => !prevState);
    let result = await axios.get(
      `${process.env.REACT_APP_API_BASE_URL}Module/GetModule/${moduleId}`
    );
    const option = {
      replace: true,
      state: {
    ...
    navigate(routeNames.CREATEMODULE, option);
  };
  ...
  const deleteModule = (moduleId) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .post(
            `${process.env.REACT_APP_API_BASE_URL}Module/deleteModule/${moduleId}`
          )
          .then((res) => {
            Swal.fire({
              icon: "success",
    ...
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <button
          ...
          onClick={() =>
            navigate(routeNames.CREATEMODULE, {
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="center">{row.moduleUrl}</TableCell>
                      ...
                      <TableCell>
                        <div style={{ display: "flex" }}>
                          ...
                          btn-primary btn-xxl"
                              ...
                              onClick={() => handleModal(row.moduleId)}
                            >
                              <EditIcon />
                            </button>
                          </div>
